VHD="txt_util.vhd cam_pkg.vhd null.vhd sim_feed.vhd sim_sink.vhd pipe_head.vhd bit_ram.vhd line_buffer.vhd window.vhd morph_kernel.vhd translate.vhd translate_win.vhd morph_new.vhd morph_set.vhd"
